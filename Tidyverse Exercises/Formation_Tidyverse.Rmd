...
g <- gapminder %>%
  ggplot(aes(x = year, y = lifeExp, label = country)) +
  geom_point() +
  geom_label() +
  geom_smooth()
...
```{r, eval=FALSE, echo = FALSE}
pgg <- ggplotly(g)
htmltools::save_html(pgg, file="ggplotly2.html")
```

 
<iframe src="ggplotly2.html" width="800" height="500" scrolling="yes" seamless="seamless" frameBorder="0"> </iframe>
